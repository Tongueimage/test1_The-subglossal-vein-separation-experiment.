...
% This program checks for the existence of an output file. If it 
% exists, the program checks to see if the old file should be deleted, or 
% if the new data should be appended to the old file.
% 
%Record of revisions:
